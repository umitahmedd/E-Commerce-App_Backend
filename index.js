...
const AddToHistory = require("./model/History/AddToHistory");
const GetUserHistory = require("./model/UserReqs/GetUserHistory");
const ClearProductsHistory = require("./model/History/ClearProductsHistory");
...
app.use("/getuserhistory", UserAuthorization, GetUserHistory);
app.use("/clearproductshistory", UserAuthorization, ClearProductsHistory);
app.use("/addtocart", UserAuthorization, AddToCart);
app.use("/addtohistory", UserAuthorization, AddToHistory);
...
app.listen(5002, "0.0.0.0", (err) => {
  !err
    ? (client.connect(), console.log("Server has started on port 5002"))
    : console.log(err);
});
